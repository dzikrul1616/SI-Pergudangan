...
class KontraktorView extends StatefulWidget {
  const KontraktorView({Key? key}) : super(key: key);

  @override
  State<KontraktorView> createState() => KontraktorViewState();
}
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('Data Kontraktor'),
        centerTitle: true,
        leading: IconButton(
            onPressed: () {
              Get.to(() => HomeView(),
